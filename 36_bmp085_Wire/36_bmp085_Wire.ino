...
uint8_t i2cRead(uint8_t address)
{
  ...
  //while(!Wire.available()); not required, see https://github.com/Koepel/How-to-use-the-Arduino-Wire-library/wiki/Common-mistakes
  return Wire.read();
}
...
int i2cReadInt(uint8_t address)
{
  ...
  //while(Wire.available()<2); not required, see https://github.com/Koepel/How-to-use-the-Arduino-Wire-library/wiki/Common-mistakes
  msb = Wire.read();
  lsb = Wire.read();
...
unsigned long i2cReadUP()
{
  ...
  //while(Wire.available() < 3); not required, see https://github.com/Koepel/How-to-use-the-Arduino-Wire-library/wiki/Common-mistakes
  msb = Wire.read();
  lsb = Wire.read();
  xlsb = Wire.read();
